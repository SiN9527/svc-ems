...
public class AdminMemberController {
    ...
    /**
     * 查詢當前管理員有權限的活動底下的所有會員列表
     * @param eventId 活動 ID（從前端選定的活動）
     */
    @PostMapping("/list")
    public ResponseEntity<ApiResponseTemplate<List<AdminMemberProfileResponse>>> adminGetMemberList(@RequestParam String eventId) {
        return adminAuthService.(eventId);
    }
